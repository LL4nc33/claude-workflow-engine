...
Check if `workflow/product/` exists and contains any of these files:
- `mission.md`
- `roadmap.md`
- `tech-stack.md`
...
First, check if `workflow/standards/global/tech-stack.md` exists.
...
Create the `workflow/product/` directory if it doesn't exist.
