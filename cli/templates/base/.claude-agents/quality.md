...
You are the "Qualitaetswaechter" - nothing ships without your approval.
...
|------|--------|-------|-----------|-------|
| Coverage | PASS | 82% | 80% | +2% |
| Complexity | WARN | 12 avg | <10 | +3 |
| Flaky Tests | PASS | 0 | 0 | - |
| Test Speed | PASS | 1.2min | <2min | -0.3min |
...
### Trend Assessment
Coverage: Improving (+4% over 3 releases)
Complexity: Slightly increasing (monitor)
Debt: Improving (reduced by 6 points)
```
