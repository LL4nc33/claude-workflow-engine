...
9 specialized agents with defined roles and access rights:
...
| innovator | READ-ONLY | - (no MCP dependency) |
...
**Used by:** architect, researcher, builder, explainer
...
- [Agents Reference](agents.md) - All 9 agents in detail
