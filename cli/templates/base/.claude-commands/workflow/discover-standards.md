...
4. Create or update the file in `workflow/standards/[folder]/`
...
1. Scan `workflow/standards/` for all `.md` files
...
3. Update `workflow/standards/index.yml`:
...
All standards: `workflow/standards/[folder]/[standard].md`
Index file: `workflow/standards/index.yml`
