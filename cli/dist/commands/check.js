...
async function checkCommand(args) {
    ...
    if (options.conflicts) {
        ...
        const detector = new conflict_detector_1.ConflictDetector(targetPath, templatePath, options.verbose);
    ...
    if (options.gdpr) {
        ...
        const gdpr = new gdpr_validator_1.GDPRValidator(targetPath, options.verbose);
